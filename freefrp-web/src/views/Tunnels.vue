  ...
  <div class="tunnels">
      ...
      >
        ...
        <template #action>
          <div class="tunnel-actions">
            <n-button size="small" @click="viewConfig(tunnel)">
              查看配置
            </n-button>
            <n-button size="small" type="warning" @click="editTunnel(tunnel)">
              编辑
            </n-button>
            <n-button size="small" type="error" @click="deleteTunnel(tunnel)">
              删除
            </n-button>
          </div>
        </template>
    ...
    <n-modal v-model:show="showCreateModal" preset="dialog" title="创建隧道">
      ...
      >
        ...
        <n-form-item v-if="createForm.type === 'tcp' || createForm.type === 'udp'" label="远程端口" path="remotePort">
          <n-input-number
        ...
        <n-form-item v-if="createForm.type === 'http' || createForm.type === 'https'" label="自定义域名" path="customDomain">
