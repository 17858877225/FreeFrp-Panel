...
export const userAPI = {
  ...
  changePassword: (data: { oldPassword: string; newPassword: string }) => api.put('/user/password', data),
  resetAccessKey: () => api.post('/user/reset-access-key'),
  realNameVerification: (data: { realName: string; idCard: string }) => api.post('/user/real-name-verification', data),
